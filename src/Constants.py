...
PROB_AUTO = 0.5
PROB_TRUCK = 0.18 #actual probability of trucks
...
V0_INIT_CAR_KMH = 40 # this is in KMH 112.65KMH = 70 mph
V0_INIT_TRUCK_KMH = 30

S0_INIT_HUMAN = 3 # minimum distance allowed
S0_INIT_AUTO = 2

# reaction time !!!
T_REACTION_HUMAN = 2.5
T_REACTION_AUTO = 0.65
